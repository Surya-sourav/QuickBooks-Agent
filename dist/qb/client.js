...
async function upsertConnection(realmId, tokenResponse) {
    ...
    const refreshExpiresAt = tokenResponse.x_refresh_token_expires_in
        ...
        : null;
    await db.query(`insert into qbo_connection (realm_id, access_token, refresh_token, expires_at, refresh_token_expires_at)
     values ($1, $2, $3, $4, $5)
     ...
     do update set access_token = excluded.access_token,
                   ...
                   updated_at = now()`, [realmId, tokenResponse.access_token, tokenResponse.refresh_token, expiresAt, refreshExpiresAt]);
}
export async function getConnection(realmId) {
...
function isExpiringSoon(connection) {
...
export async function qboFetch(path, init) {
